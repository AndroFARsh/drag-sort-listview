...
import com.mobeta.android.dslv.DragSortExpandableListConnector.PositionMetadata;
/**
 ...
 * default style for an {@link DragSortExpandableListView} provides indicators which
 * will be shown next to Views given to the {@link DragSortExpandableListView}. The
 ...
 * for indicators.
 * <p>
 * The context menu information set by an {@link DragSortExpandableListView} will be a
 ...
 * 100 pixels.
 * 
 * @attr ref android.R.styleable#DragSortExpandableListView_groupIndicator
 * @attr ref android.R.styleable#DragSortExpandableListView_indicatorLeft
 * @attr ref android.R.styleable#DragSortExpandableListView_indicatorRight
 * @attr ref android.R.styleable#DragSortExpandableListView_childIndicator
 * @attr ref android.R.styleable#DragSortExpandableListView_childIndicatorLeft
 * @attr ref android.R.styleable#DragSortExpandableListView_childIndicatorRight
 * @attr ref android.R.styleable#DragSortExpandableListView_childDivider
 */

public class DragSortExpandableListView extends DragSortListView {
    ...
    private DragSortExpandableListConnector mConnector;
    ...
    public DragSortExpandableListView(Context context, AttributeSet attrs) {
        this(context, attrs, R.attr.dragSortExpandableListView);
    }

    public DragSortExpandableListView(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);

        TypedArray a =
            context.obtainStyledAttributes(attrs, R.styleable.DragSortExpandableListView, defStyle,
                    0);

        mGroupIndicator = a
                .getDrawable(R.styleable.DragSortExpandableListView_groupIndicator);
        mChildIndicator = a
                .getDrawable(R.styleable.DragSortExpandableListView_childIndicator);
        mIndicatorLeft = a
                .getDimensionPixelSize(R.styleable.DragSortExpandableListView_indicatorLeft, 0);
        mIndicatorRight = a
                .getDimensionPixelSize(R.styleable.DragSortExpandableListView_indicatorRight, 0);
        if (mIndicatorRight == 0 && mGroupIndicator != null) {
            mIndicatorRight = mIndicatorLeft + mGroupIndicator.getIntrinsicWidth();
        }
        mChildIndicatorLeft = a.getDimensionPixelSize(
                R.styleable.DragSortExpandableListView_childIndicatorLeft, CHILD_INDICATOR_INHERIT);
        mChildIndicatorRight = a.getDimensionPixelSize(
                R.styleable.DragSortExpandableListView_childIndicatorRight, CHILD_INDICATOR_INHERIT);
    ...
    @Override
    public void setDragValidateListener(
    		DragValidateListener dragValidateListener) {
    ...
    private int getGroupFlags() {
    	try {
			return getClass().getDeclaredField("mGroupFlags").getInt(this);
    ...
    protected void dispatchDraw(Canvas canvas) {
        ...
        int lastItemType = ~(DragSortExpandableListPosition.CHILD | DragSortExpandableListPosition.GROUP);
        ...
        for (int i = 0, childFlPos = getFirstVisiblePosition() - headerViewsCount; i < childCount;
             i++, childFlPos++) {
            ...
            if (pos.position.type != lastItemType) {
                if (pos.position.type == DragSortExpandableListPosition.CHILD) {
    ...
    private Drawable getIndicator(PositionMetadata pos) {
        ...
        if (pos.position.type == DragSortExpandableListPosition.GROUP) {
    ...
    public void setAdapter(ExpandableListAdapter adapter) {
        ...
        if (adapter != null) {
            ...
            mConnector = new DragSortExpandableListConnector(adapter);
        } else {
            mConnector = null;
        }
    ...
    boolean handleItemClick(View v, int position, long id) {
        ...
        boolean returnValue;
        if (posMetadata.position.type == DragSortExpandableListPosition.GROUP) {
    ...
    public boolean expandGroup(int groupPos, boolean animate) {
        DragSortExpandableListPosition elGroupPos = DragSortExpandableListPosition.obtain(
                DragSortExpandableListPosition.GROUP, groupPos, -1, -1);
    ...
    public interface OnGroupClickListener {
         ...
         */
        boolean onGroupClick(DragSortExpandableListView parent, View v, int groupPosition,
                long id);
    }
    ...
    public interface OnChildClickListener {
         ...
         * @return True if the click was handled
         */
        boolean onChildClick(DragSortExpandableListView parent, View v, int groupPosition,
     ...
     * {@link DragSortExpandableListView#getPackedPositionType} ,
     * {@link DragSortExpandableListView#getPackedPositionChild},
     * {@link DragSortExpandableListView#getPackedPositionGroup} to unpack.
     * 
    ...
    public int getFlatListPosition(long packedPosition) {
        DragSortExpandableListPosition elPackedPos = DragSortExpandableListPosition
    ...
    public void setSelectedGroup(int groupPosition) {
        DragSortExpandableListPosition elGroupPos = DragSortExpandableListPosition
    ...
    public boolean setSelectedChild(int groupPosition, int childPosition, boolean shouldExpandGroup) {
        DragSortExpandableListPosition elChildPos = DragSortExpandableListPosition.obtainChildPosition(
     ...
     * {@link ExpandableListAdapter} or {@link DragSortExpandableListView} method can
     ...
     *            returned.
     */
    private long getChildOrGroupId(DragSortExpandableListPosition position) {
        if (position.type == DragSortExpandableListPosition.CHILD) {
    ...
    /**
     * Extra menu information specific to an {@link DragSortExpandableListView} provided
     * to the
    ...
    public static class ExpandableListContextMenuInfo implements ContextMenu.ContextMenuInfo {
         ...
         * will be one of the children Views of this {@link DragSortExpandableListView}.
         */
         ...
         * {@link DragSortExpandableListView#getPackedPositionType},
         * {@link DragSortExpandableListView#getPackedPositionChild}, and
         * {@link DragSortExpandableListView#getPackedPositionGroup} to unpack this.
         */
    ...
    static class SavedState extends BaseSavedState {
        ArrayList<DragSortExpandableListConnector.GroupMetadata> expandedGroupMetadataList;
        
        /**
         * Constructor called from {@link DragSortExpandableListView#onSaveInstanceState()}
         */
        SavedState(
        ...
        private SavedState(Parcel in) {
            super(in);
            expandedGroupMetadataList = new ArrayList<DragSortExpandableListConnector.GroupMetadata>();
            in.readList(expandedGroupMetadataList, DragSortExpandableListConnector.class.getClassLoader());
        }
    ...
    public void onInitializeAccessibilityEvent(AccessibilityEvent event) {
		if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.ICE_CREAM_SANDWICH){
			...
			event.setClassName(DragSortExpandableListView.class.getName());
		}
    }
    ...
    public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo info) {
    	if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.ICE_CREAM_SANDWICH){
    		...
    		info.setClassName(DragSortExpandableListView.class.getName());
    	}
    }
    ...
    class DragSortListenerImpl implements DragValidateListener, DragSortListener {
		...
		public boolean isAllow(int srcPos, int newPos, DragSortListView list) {
			if (mConnector != null){
				final PositionMetadata newUnfltPos = mConnector.getUnflattenedPos(newPos);
				if (newUnfltPos.position.type == DragSortExpandableListPosition.GROUP){
					return false;
				}
	
				final PositionMetadata srcUnfltPos = mConnector.getUnflattenedPos(srcPos);
				if (newUnfltPos.position.groupPos != srcUnfltPos.position.groupPos){
					return false;
				}
				
				if (mDragChildValidateListener != null && 
					!mDragChildValidateListener.isAllow(srcUnfltPos.position.groupPos, 
														srcUnfltPos.position.childPos, 
														newUnfltPos.position.groupPos, 
														newUnfltPos.position.childPos, list)){
					return false;
				}
